    ...
    public class AiService
    {
        ...
        public async Task<AiParameters> GetParamsFromGemmaAsync(string input)
        {
            var requestBody = new
            {
                ...
                messages = new[]
                {
                    new { role = "system", content = @"Sei un estrattore di parametri JSON.
                    ...
                    4. Restituisci ESATTAMENTE E SOLO un JSON valido con questa struttura: { ""title_query"": """", ""actor_query"": """", ""genre_id"": """", ""year_start"": 0, ""year_end"": 0, ""vote_average"": 0 }" },
